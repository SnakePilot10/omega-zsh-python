...
def test_action_config_themes_discovery(mock_path, mock_app):
    ...
    def side_effect_home_div(arg):
        ...
        if arg == ".oh-my-zsh":
             m.__truediv__.side_effect = lambda x: mock_omz_themes_path if x == "themes" else (mock_user_custom_path if x == "custom/themes" else MagicMock())
    ...
    with patch("omega_zsh.ui.app.Path") as MockPathClass:
        ...
        MockPathClass.return_value.parent.parent.__truediv__.return_value = mock_asset_path_obj
