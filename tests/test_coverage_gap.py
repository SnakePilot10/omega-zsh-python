...
def test_base_platform_abstracts():
    ...
    class ConcretePlatform(BasePlatform):
        def get_shell_config_path(self):
            return Path(".zshrc")

        def install_package(self, pkg, on_progress=None):
            pass

        def get_essential_tools(self):
            return []

        def update_repos(self, on_progress=None):
            pass
...
def test_base_platform_run_cmd_internal(mock_popen):
    ...
    class ConcretePlatform(BasePlatform):
        ...
        def install_package(self, package_name: str, on_progress=None) -> bool:
            pass
